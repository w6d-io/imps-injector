...
# w6d.io/imps-injector-bundle:$VERSION and w6d.io/imps-injector-catalog:$VERSION.
IMAGE_TAG_BASE ?= w6d.io/imps-injector
...
IMG ?= docker.io/w6dio/imps-injector:latest
...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	$(CONTROLLER_GEN) rbac:roleName=imps-injector-role crd webhook paths="./..." output:crd:artifacts:config=config/crd/bases
...
build: generate fmt vet ## Build manager binary.
	go build -o bin/imps-injector main.go
